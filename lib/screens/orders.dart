// ignore_for_file: unused_field, avoid_print, no_leading_underscores_for_local_identifiers, avoid_unnecessary_containers, sized_box_for_whitespace
...
class _OrdersState extends State<Orders> {
  ...
  fetchData() async {
    ...
    _isInitial = false;
    _totalData = orderResponse.total;
    _showLoadingContainer = false;
    setState(() {});
  }
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(_orderList[index].deliveryHistoryDate,
                          style: TextStyle(
                              color: MyTheme.font_grey,
                              fontSize: 12,
