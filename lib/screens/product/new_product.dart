// ignore_for_file: unnecessary_getters_setters, unused_element, avoid_print, prefer_typing_uninitialized_variables, use_build_context_synchronously
...
class _NewProductState extends State<NewProduct> {
  ...
  setChoiceAtt() {
    ...
    for (var element in selectedAttributes) {
      ...
      choiceOptions.addAll({"choice_options_${element.name.key}": tmpValue});
    }
  ...
  submitProduct(String button) async {
    ...
    postValue.addAll(choiceOptions);
    if (refund_addon.$) {
