// ignore_for_file: non_constant_identifier_names, unused_field, avoid_print, prefer_typing_uninitialized_variables, use_build_context_synchronously, sized_box_for_whitespace, avoid_unnecessary_containers
      ...
      child: const Center(
        child: Column(
          ...
          children: [
            ...
            CircularProgressIndicator(color: MyTheme.app_accent_color,),
            SizedBox(
              height: 10,
              width: 2,
            ),
    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          ...
          return AlertDialog(
              content: Row(
            children: [
              const CircularProgressIndicator(color: MyTheme.app_accent_color,),
              const SizedBox(
                width: 10,
              ),
